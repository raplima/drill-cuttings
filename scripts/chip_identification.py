...
img_name = '485140_01_500nm_BSED'
fname_in = f'g:/My Drive/Projects/drill-cuttings/data/BS/{img_name}.tif'
data_out_dir = 'g:/My Drive/Projects/drill-cuttings/data/BS_crops/'
...
min_chip = (2e5*2e5) / (scale_nm_per_pixel**2)
...
labels = morphology.remove_small_holes(labels, min_chip)
